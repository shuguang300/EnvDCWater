...
public class NfcUtil {
	...
	public static String[] intentActions = new String[] {NfcAdapter.ACTION_NDEF_DISCOVERED,NfcAdapter.ACTION_TAG_DISCOVERED,NfcAdapter.ACTION_TECH_DISCOVERED };
	public static String [][] techList = new String[][] { new String[] {MifareClassic.class.getName()}};
	public static IntentFilter [] intentFilters = new IntentFilter[]{new IntentFilter(NfcAdapter.ACTION_TECH_DISCOVERED),new IntentFilter(NfcAdapter.ACTION_NDEF_DISCOVERED)};
