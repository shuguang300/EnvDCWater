...
public class PullToRefreshView extends ListView implements OnScrollListener{
	...
	// -- header view
	private PullToRefreshHeadView mHeaderView;
	...
	private void updateHeaderHeight(float delta) {
		...
		if (mEnablePullRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
			if (mHeaderView.getVisiableHeight() > mHeaderViewHeight) {
				...
				mHeaderView.setState(PullToRefreshHeadView.STATE_NORMAL);
			}
		}
		...
		default:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				if (mEnablePullRefresh
					...
					mHeaderView.setState(PullToRefreshHeadView.STATE_REFRESHING);
					if (mListViewListener != null) {
